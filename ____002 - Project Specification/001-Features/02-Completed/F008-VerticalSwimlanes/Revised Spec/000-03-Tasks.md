...
17. fix node popup gui

18. create duplicate y shadow stack
19. change y shadow label font color to black
20. add treeLevel as a property
21. link colors
22. data summary gui with num nodes, links