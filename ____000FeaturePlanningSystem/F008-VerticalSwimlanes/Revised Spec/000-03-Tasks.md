...
- get rid of the front and left vertical walls
- get rid of all the child walls inside the back and right walls

- group is only activating when I change the dropdown.  i should activate on load

 - on y shadows make the label text on each face a different color
- set can collide to false on  y planes
-- make material concrete
