...
## gui code audit
- create a doc called 000-GUIs-audit
- provide ascii depiction of current guis
- provide a mermaid flowchart of all files involved in the guis
- provide a list of the files and their sizes
- provide suggestions for refactoring to separate concerns.


- on person endcaps font size on the long surfaces should be the same. - see image