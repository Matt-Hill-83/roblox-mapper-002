...
function checkFlagConnections() {
  ...
  console.log(`❌ Entity flags WITHOUT connections: ${flagsNotInRelations.length}`);
  console.log(`📈 Connection rate: ${((flagsInRelations.length / flagGUIDs.length) * 100).toFixed(1)}%`);
